...
# with command line options: dir1/dir2/python/fragment_HYDJET.py --fileout file:HYDJET_HINPbPbAutumn18_stepGEN.root --mc --eventcontent RAWSIM --no_exec --datatier GEN --conditions 103X_upgrade2018_realistic_HI_v11 --beamspot RealisticPbPbCollision2018 --step GEN --scenario HeavyIons --geometry DB:Extended --era Run2_2018_pp_on_AA
import FWCore.ParameterSet.Config as cms

from Configuration.StandardSequences.Eras import eras

process = cms.Process('GEN',eras.Run2_2018_pp_on_AA)
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('dir1/dir2/python/fragment_HYDJET.py nevts:1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HYDJET_HINPbPbAutumn18_stepGEN.root'),
